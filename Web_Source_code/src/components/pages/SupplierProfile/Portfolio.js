...
export default function UserProfile_wishlist() {
  ...
  return (
    ...
    {portfolio[0] ?(
      <>
     {portfolio.map((p) =>  (<div className='md:flex text-left space-x-5 mt-4 p-8 shadow-lg md:w-[880px] rounded-lg overflow-hidden w-[350px] '>
        <div className='md:w-full w-[275px]'>
