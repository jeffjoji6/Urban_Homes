  ...
  return (
    ...
    <div className='bg-white-800 md:ml-20 p-8 text-white text-center w-full-z-10'>
      ...
      <Link
        ...
        className=" hover:text-[#994B00] block text-black font-semibold h-1/6 w-80 py-2   transition duration-300"
      >
        Portfolio
        <div className='bg-gray-400 bg-opacity-50 mt-3 h-1'></div>
      </Link>
          ...
          <div className='flex-col w-full space-y-3 px-3 mt-10'>
            ...
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              <div className='flex-col md:w-1/2 '>
                ...
                <div className='w-full'>
                  <input type="text" id='name' name='full_name'  onChange={handleInputChange}
            ...
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              ...
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" id='zip_code' name='zip_code'  onChange={handleInputChange} value={userdata.zip_code} placeholder={user.zip_code} className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
            </div>
            <div className='justify-start py-2 pb-16 pd:mb-4 w-full'>
              <div className='flex-col md:w-1/2 '>
                ...
                <div className='w-full'>
                  <input type="text" id='experience' name='experience'  onChange={handleInputChange} value={userdata.experience} placeholder={user.experience} className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
