        ...
        <div className='flex-col  border p-6 md:p-14 md:w-full w-[350px]'>
          <div className='md:flex md:space-x-8'>
            {file?(
              ...
              <div className='grid md:grid-flow-col mt-10 space-y-5 items-center md:space-y-0 md:space-x-6 w-full justify-stretch'>
          ...
          <div className='flex-col w-full space-y-3 mt-10'>
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input required type="text" id='email' name='email' placeholder={user.email} onChange={handleInputChange} value={userdata.email} className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
              <div className='flex-col md:w-1/2 px-3'>
                <h2 className='text-gray-800 pl-1  md:pb-2 text-md'>
            ...
            <div className='justify-start py-2 pb-16 pd:mb-4 w-full'>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input required type="text" id='zip_code' name='zip_code'  onChange={handleInputChange} value={userdata.zip_code} placeholder={user.zip_code} className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>              
            </div>
