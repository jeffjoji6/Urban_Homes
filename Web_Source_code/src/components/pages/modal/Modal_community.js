...
const Modal_community = ({ isvisible,onClose}) => {
  ...
  <div><br/></div>
          ...
          <div className='flex pt-5 pl-20 md:pl-60  '>
          <button className='cursor-pointer border border-yellow-700 hover:border-slate-500 rounded-3xl shadow-lg hover:bg-yellow-700 h-10 w-24 text-slate-500 hover:text-white' onClick={() => onClose()}>Close</button>
          <div className='mx-5'>
