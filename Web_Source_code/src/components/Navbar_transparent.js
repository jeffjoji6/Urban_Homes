   ...
   onClick={()=>{setDropdown((prev)=>(!prev))}}
        ...
        {dropdown && (<div class="p-2 z-20 mt-6 items-center justify-between fixed inset-y-10 start-0 w-full md:flex md:w-auto md:order-1" id="navbar-search">
            <div class="relative mt-3 md:hidden">
              ...
              <input type="text" id="search-navbar" class="block shadow-lg  w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#ffffffea] focus:ring-1 focus:ring-[#994b00] " placeholder="Search..."></input>
            </div>
            ...
            <li onClick={handleDropdownClick}>
              ...
              {category==="Home Owner" &&(<Link  to='/UserProfile/profile'>
                <img src={`../uploads/${user.profile_pic}`} className='h-10 w-10 border block object-cover rounded-full'></img>
