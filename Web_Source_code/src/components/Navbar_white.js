            ...
            <div className="hidden md:flex space-x-16">
              ...
              <div className="flex-col">
                <button
                  ...
                  className="inline-flex space-x-2 items-center  text-gray-600"
                >
                ...
                {FindProfessionals && (
                  <div className="absolute mt-4 text-center divide-y-2 -translate-x-5 w-48 shadow-lg shadow-gray-800 bg-white flex flex-col z-10 ">
                    <Link
                      ...
                      className="text-gray-700 hover:text-white hover:bg-[#994b00] transition-all  py-2"
                    >
                      Builders
                    </Link>
                    <Link
                      ...
                      className="text-gray-700 py-2 hover:text-white hover:bg-[#994b00] transition-all "
                    >
                      Designer
                    </Link>
                    <Link
                        ...
                        <div className=" justify-center text-white bg-[#994b005a] p-2 rounded-lg w-full border inline-flex">
                          {category === "Home Owner" && (
                            <Link to="/UserProfile/profile">
                              <img
                                src={`../uploads/${user.profile_pic}`}
                                className=" text-white h-10 w-10 border block object-cover rounded-full"
                              ></img>
