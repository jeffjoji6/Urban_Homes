...
function Navbar() {
    ...
    <>
      ...
      <nav >
        ...
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
          <Link to='/'>
            <img src={logo} class=" " alt="HalaHomes Logo"  />
          </Link>
        </a>
        <div className='hidden md:flex space-x-16'>
          ...
          >
            ...
            <div className='absolute mt-4 text-center divide-y-2 -translate-x-5 w-48 shadow-lg shadow-gray-800 bg-white flex flex-col z-10 '>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/builder' className='text-gray-700 hover:text-white hover:bg-[#994b00] transition-all  py-2'>
                Builders
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/Designer' className='text-gray-700 py-2 hover:text-white hover:bg-[#994b00] transition-all '>
                Designer
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/supplier' className='text-gray-700 py-2 hover:text-white hover:bg-[#994b00] transition-all '>
                Supplier
               </Link>
            </div>)}
          </div>
  ...
  <button onClick={handleProfile} className='hidden px-16 md:inline-flex items-center space-x-4 text-white'>
            <img src={`../uploads/${user.profile_pic}`} className='h-10 w-10 border object-cover rounded-full'></img>
            <p>{user.full_name}</p>
            <svg
          ...
          >
            ...
            {Profile && category==="Home Owner" && (
              <div className='absolute mt-4 divide-y-2 translate-y-32 w-48 shadow-lg shadow-gray-500 bg-white flex flex-col z-10 '>
                 <Link onClick={handleProfile} to='/UserProfile/profile' className='text-gray-700 hover:bg-[#994b00] transition-all hover:text-white py-2'>
                  Profile
                 </Link>
                 <Link onClick={handleProfile} to='/UserProfile/posts' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Posts
                 </Link>
                 <Link onClick={handleProfile} to='/UserProfile/messages' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Messages
                 </Link>
                 <Link onClick={handleProfile} to='/UserProfile/wishlist' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Wishlist
                 </Link>
                 <Link onClick={handleLogout} to='/log-in' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Sign Out
                 </Link>
              </div>
          )
          ...
          {Profile && category==="Supplier" && (
              <div className='absolute mt-4 divide-y-2 translate-y-32 w-48 shadow-lg shadow-gray-500 bg-white flex flex-col z-10 '>
                 <Link onClick={handleProfile} to='/SupplierProfile/profile' className='text-gray-700 hover:bg-[#994b00] transition-all hover:text-white py-2'>
                  Profile
                 </Link>
                 <Link onClick={handleProfile} to='/SupplierProfile/portfolio' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                 Portfolio

                 </Link>
                 <Link onClick={handleProfile} to='/SupplierProfile/messages' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Messages
                 </Link>
                 <Link onClick={handleProfile} to='/SupplierProfile/wishlist' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Wishlist
                 </Link>
                 <Link onClick={handleLogout} to='/log-in' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Sign Out
          ...
          {Profile && category==="Builder" && (
              <div className='absolute mt-4 divide-y-2 translate-y-32 w-48 shadow-lg shadow-gray-500 bg-white flex flex-col z-10 '>
                 <Link onClick={handleProfile} to='/BuilderProfile/profile' className='text-gray-700 hover:bg-[#994b00] transition-all hover:text-white py-2'>
                  Profile
                 </Link>
                 <Link onClick={handleProfile} to='/BuilderProfile/portfolio' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Portfolio
                 </Link>
                 <Link onClick={handleProfile} to='/BuilderProfile/messages' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Messages
                 </Link>
                 <Link onClick={handleProfile} to='/BuilderProfile/wishlist' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Wishlist
                 </Link>
                 <Link onClick={handleLogout} to='/log-in' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Sign Out
          ...
          {Profile && category==="Designer" && (
              <div className='absolute mt-4 divide-y-2 translate-y-32 w-48 shadow-lg shadow-gray-500 bg-white flex flex-col z-10 '>
                 <Link onClick={handleProfile} to='/DesignerProfile/profile' className='text-gray-700 hover:bg-[#994b00] transition-all hover:text-white py-2'>
                  Profile
                 </Link>
                 <Link onClick={handleProfile} to='/DesignerProfile/portfolio' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                 Portfolio

                 </Link>
                 <Link onClick={handleProfile} to='/DesignerProfile/messages' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Messages
                 </Link>
                 <Link onClick={handleProfile} to='/DesignerProfile/wishlist' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Wishlist
                 </Link>
                 <Link onClick={handleLogout} to='/log-in' className='text-gray-700 py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                  Sign Out
  ...
  <Link to='/log-in'>
  <button className=' border-2 border-white py-2 px-5 bg-white ml-6 rounded-full login_btn'>Login</button>
</Link>
)}
<div className={`md:hidden z-20 top-0 left-0 ${dropdown && "bg-gray-700 w-full h-full bg-opacity-25 backdrop-blur-sm"}  fixed transition-all`}>
...
{dropdown && (<div class="p-2 z-20 mt-6 items-center justify-between fixed inset-y-10 start-0 w-full md:flex md:w-auto md:order-1" id="navbar-search">
 ...
 <li onClick={handleDropdownClick}>
   {isLoggedIn ?( <div className=' justify-center text-white bg-[#994b005a] p-2 rounded-lg w-full border inline-flex'>
   {category==="Home Owner" &&(<Link  to='/UserProfile/profile'>
     <img src={`../uploads/${user.profile_pic}`} className=' text-white h-10 w-10 border block object-cover rounded-full'></img>
     <p className='text-white'>{user.full_name}</p>
   </Link>)}
   {category==="Builder" &&(<Link  to='/BuilderProfile/profile'>
     <img src={`../uploads/${user.profile_pic}`} className=' h-10 w-10 border object-cover rounded-full'></img>
     <p className='text-white'>{user.full_name}</p>
   </Link>)}
   {category==="Supplier" &&(<Link  to='/SupplierProfile/profile'>
   ...
   {category==="Designer" &&(<Link  to='/DesignerProfile/profile'>
     <img src={`../uploads/${user.profile_pic}`} className='h-10 w-10 border object-cover rounded-full'></img>
     <p className='text-white'> {user.full_name}</p>
   </Link>)}
   </div>
   ):(
     <Link to='/log-in'className='text-white'><a class="block py-2 px-3 text-white bg-[#994b00] rounded md:bg-transparent md:text-[#994b00] md:p-0">Login</a></Link>
   )}
   </li>
   <li>
   ...
   {isLoggedIn && (<li>
                <Link onClick={handleLogout} to='/log-in' className='block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0  '>
                Sign Out
              </Link>
              </li>)}
