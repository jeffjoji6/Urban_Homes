...
class SpamBlock extends Component {
  constructor(props) {
    super(props);
    this.state = {
      deleteModel: false,
  ...
  getSpamUserList = () => {
    const apiUrl = `${config.Url}spamblock/getAllSpamBlockUserList`;
    ...
    fetch(apiUrl, {
      ...
      .then((data) => {
        if (data.status === 200) {
          ...
          this.setState({ spamUserLists: data.data });
  ...
  handleDelete = () => {
    const apiUrl = `${config.Url}post/${this.state.user_Id}`;
    const token = localStorage.getItem("token");
  ...
  handlePageChange(page) {
    ...
    const apiUrl = `${config.Url}spamblock/getAllSpamBlockUserList?page=${
      page ? page : 1
        ...
        <div className="AllUsersView_sect">
          ...
          <div className="table_sect">
            <div className="table_inner">
              <table className="table">
                ...
                <tbody>
                  {this.state.spamUserLists &&
                    this.state.spamUserLists.map((user, index) => (
                      <tr>
                        <td>
                          <div class="iagt">
                        ...
                        <td>
                          {moment(user.created_at).format("ddd, DD MMM YYYY")}
                        </td>
                        <td>
                          <div className="Spam">
                            {" "}
                        ...
                        <td>
                          <div className="action_btn">
                            ...
                            <button
                              className="btn"
                              onClick={() => this.openDeleteModal(user.post_id)}
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
                ...
                <td>66455</td>
                <td>Oct,11th 2023</td>
                <td><div className='Spam'>Block user</div>
                </td>
                <td>
                <div className='action_btn'>
                    <Link to="/spamBlockView">
          ...
          <div className="pagenation_item">
            <h3>
              ...
              Showing{" "}
              {this.state.spamUserLists &&
                this.state.spamUserLists.length} from {this.state.totalUser}{" "}
              data
            </h3>
